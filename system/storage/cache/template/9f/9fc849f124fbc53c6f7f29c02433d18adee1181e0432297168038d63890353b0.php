...
class __TwigTemplate_afa7c9365d5774538e27bbc59f289675e241370c150ee4aeb66188ddaa76e884 extends \Twig\Template
{
    private $source;
    private $macros = [];
    ...
    ";
      ...
      <div class=\"panel-body\">
        ...
        echo "',
          ...
          <div class=\"form-group\">
            <label class=\"col-sm-2 control-label\" for=\"input-complete-status\"><span data-toggle=\"tooltip\" title=\"\" data-original-title=\"Set the order status the customer's order must reach before they are allowed to access their downloadable products and gift vouchers.\" aria-describedby=\"tooltip876274\">Complete Order Status</span></label>
            <div class=\"col-sm-10\">
              <div class=\"well well-sm\" style=\"height: 150px; overflow: auto;\">                       <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"7\">
                    Canceled
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"9\">
                    Canceled Reversal
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"13\">
                    Chargeback
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"5\" checked=\"checked\">
                    Complete
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"8\">
                    Denied
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"14\">
                    Expired
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"10\">
                    Failed
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"1\">
                    Pending
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"15\">
                    Processed
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"2\">
                    Processing
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"11\">
                    Refunded
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"12\">
                    Reversed
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"3\" checked=\"checked\">
                    Shipped
                  </label>
                </div>
                <div class=\"checkbox\">
                  <label>                           <input type=\"checkbox\" name=\"config_complete_status[]\" value=\"16\">
                    Voided
                  </label>
                </div>
              </div>
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["tax_class"]) {
            // line 283
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 283) == ($context["shipping_qweqr_tax_class_id"] ?? null))) {
                // line 284
                echo "                <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 284);
                echo "\" selected=\"selected\">";
                echo twig_get_attribute($this->env, $this->source, $context["tax_class"], "title", [], "any", false, false, false, 284);
                echo "</option>
                ";
            } else {
                // line 286
                echo "                <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["tax_class"], "tax_class_id", [], "any", false, false, false, 286);
                echo "\">";
        ...
        foreach ($context['_seq'] as $context["_key"] => $context["geo_zone"]) {
            // line 299
            echo "                ";
            if ((twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 299) == ($context["shipping_qweqr_geo_zone_id"] ?? null))) {
                // line 300
                echo "                <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 300);
                echo "\" selected=\"selected\">";
                echo twig_get_attribute($this->env, $this->source, $context["geo_zone"], "name", [], "any", false, false, false, 300);
                echo "</option>
                ";
            } else {
                // line 302
                echo "                <option value=\"";
                echo twig_get_attribute($this->env, $this->source, $context["geo_zone"], "geo_zone_id", [], "any", false, false, false, 302);
                echo "\">";
                echo twig_get_attribute($this->env, $this->source, $context["geo_zone"], "name", [], "any", false, false, false, 302);
                echo "</option>
                ";
            }
            // line 304
...
";
    ...
    {
        return array (  629 => 337,  614 => 327,  609 => 325,  602 => 320,  597 => 318,  592 => 317,  587 => 315,  582 => 314,  580 => 313,  574 => 310,  567 => 305,  561 => 304,  553 => 302,  545 => 300,  542 => 299,  538 => 298,  534 => 297,  528 => 294,  521 => 289,  515 => 288,  507 => 286,  499 => 284,  496 => 283,  492 => 282,  488 => 281,  482 => 278,  342 => 141,  322 => 124,  313 => 117,  309 => 115,  305 => 113,  303 => 112,  299 => 111,  273 => 88,  262 => 80,  256 => 79,  249 => 77,  239 => 70,  233 => 66,  227 => 64,  225 => 63,  222 => 62,  208 => 61,  200 => 59,  192 => 57,  190 => 56,  185 => 55,  168 => 54,  163 => 52,  157 => 49,  151 => 45,  145 => 43,  143 => 42,  137 => 41,  132 => 39,  126 => 35,  120 => 33,  118 => 32,  112 => 31,  107 => 29,  102 => 27,  96 => 24,  92 => 22,  84 => 18,  82 => 17,  76 => 13,  65 => 11,  61 => 10,  56 => 8,  50 => 7,  46 => 6,  37 => 1,);
    }
